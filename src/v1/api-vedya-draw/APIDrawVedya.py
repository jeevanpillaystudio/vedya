...
# from .config import ScaleConfig, FabricationMethod, DepthEffect
...
#     OuterDiagonalRectangleStrokeWeight = (
#         AppConfig.StrokeWeight * ScaleConfig.ScaleFactor
#     )
...
#     MiddleDiagonalRectangleStrokeWeight = (
#         AppConfig.StrokeWeight * ScaleConfig.ScaleFactor
#     )
...
#     InnerDiagonalRectangleStrokeWeight = (
#         AppConfig.StrokeWeight * ScaleConfig.ScaleFactor
#     )
...
class ContextHandler:
    def __init__(
        self,
        context: adsk.core.Application,
        design_mode: adsk.fusion.DesignTypes,
        seed: int,
        ...
        # set the fabrication method
        self.fabrication_method = fabrication_method

        # set the design mode
        self.design().designType = design_mode

        log(
            f"DEBUG: ContextHandler: design_mode:{self.design().designType}, fabrication_method:{FabricationMethod.get_attr_name(self.fabrication_method)}, seed:{seed}"
        )
    ...
    def is_runnable(self):
        if not self.design().designType == DesignMode.DirectDesign:
            raise Exception(
                "It is not supported in current workspace, please switch to DIRECT-DESIGN workspace and try again."
            )

    def ui(self):
        return self.fusion_context.userInterface

    def root_component(self):
        return self.fusion_context.activeProduct.rootComponent

    def design(self):
        return self.fusion_context.activeProduct


@timer
def run(context):
    log(f"DEBUG: start run func")
    ui = None
    try:
        # create context runner
        context = ContextHandler(
            context=adsk.core.Application.get(),
            design_mode=DesignMode.DirectDesign,
            seed=create_seed(),
            fabrication_method=FabricationMethod.CNC,
        )
        ...
        #     component=root_component, name=create_component_name("cylindrical-sol")
        # ):
        #     # draw cylinder
        ...
        #         extrude_height=AppConfig.LayerDepth * 32,
        #         name="cut-hole",
        #         operation=adsk.fusion.FeatureOperations.NewBodyFeatureOperation,
        #     )

        # # now draw seed of life
        ...
        #     stroke_weight=AppConfig.StrokeWeight / 8,
        #     layer_offset=start_layer_offset,
        #     side=DepthEffect.Center,
        #     plane=core_structural_comp.xZConstructionPlane,
        #     start_from=core_structural_comp.bRepBodies.item(0).faces.item(0),
        # )
        ...
        # create_component_outer_diagonal_steps(root_component)
...
#             [
#                 [
#                     20 * ScaleConfig.ScaleFactor,
#                     0.96 * ScaleConfig.ScaleFactor,
#                     AppConfig.LayerDepth * 2,
#                     4,
#                 ],
#                 [
#                     64 * ScaleConfig.ScaleFactor,
#                     2.88 * ScaleConfig.ScaleFactor,
...
#             [
#                 (
#                     28 * ScaleConfig.ScaleFactor,
#                     1.92 * ScaleConfig.ScaleFactor,
#                     AppConfig.LayerDepth * 4,
#                     6,
#                 ),
#                 (
#                     16 * ScaleConfig.ScaleFactor,
#                     0.96 * ScaleConfig.ScaleFactor,
#                     AppConfig.LayerDepth * 2,
#                     4,
#                 ),
...
#             [
#                 [
#                     44 * ScaleConfig.ScaleFactor,
#                     0.96 * ScaleConfig.ScaleFactor,
#                     AppConfig.LayerDepth * 4,
#                     6,
#                 ],
#                 [
#                     72 * ScaleConfig.ScaleFactor,
#                     0.96 * ScaleConfig.ScaleFactor,
#                     AppConfig.LayerDepth * 2,
#                     4,
#                 ],
...
#     return f"{FabricationMethod.get_attr_name(ScaleConfig.ScaleFactor).lower()}-{name}"
