...
def run(context):
    ...
    try:
        ...
        if not design:
            ui.messageBox(
                "It is not supported in current workspace, please switch to DESIGN workspace and try again."
            )
            return
        ...
        if not component_exist(root_comp, create_component_name("cylindrical-sol")):
            # draw cylinder
